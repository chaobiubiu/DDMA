import numpy as np
import torch
from algorithm.madqn import MADQN

class MADQN_Agent:
    def __init__(self, agent_id, args):
        self.args = args
        self.agent_id = agent_id
        self.policy = MADQN(args, agent_id)
    ...
    def learn(self, transitions, other_agents, logger):
        self.policy.train(transitions, other_agents, logger)
